...
set term pdfcairo size 12,12 enhanced font "Arial-Bold,55"
set output 'kernbench_vFresh.pdf

# Don't show the legend in the chart
set key top center box font "Arial-Bold,55" width -1 height 1 maxcols 1 maxrows 2  spacing 1
...
set yrange [0:200]
set ytics 0,50,200 font "Arial-Bold,55"
set xtics font "Arial-Bold,55" rotate by -20 offset 0,0
#set xtics offset 2
