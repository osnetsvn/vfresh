...
set yrange [0:250]
set ytics 0,50,250 font "Arial-Bold,35"
set xtics font "Arial-Bold,35" 
set xtics offset 2

#set output "6.png"
plot "cpu_util_iperf.dat" using 2:xticlabels(1) title "User" lt rgb "#e55964" , \
	'' using 3 title "System" lt rgb "#fb8761", \
	'' using 4 title "Guest" lt rgb "#fcffa4"
