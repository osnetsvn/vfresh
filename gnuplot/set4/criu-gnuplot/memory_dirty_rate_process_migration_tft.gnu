...
set output 'memory_dirty_rate_process_migration_tft.pdf'
...
set ylabel 'Total Frozen Time (s)'
set xrange [0:1200]
set yrange [0:3]

plot 'memory_dirty_rate_process_migration_tft.dat' u 1:3 t 'CRIU' w lp ls 1, \
